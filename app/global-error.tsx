...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="bg-[#0D0D0D] text-[#FFFFFF] font-mono flex flex-col items-center justify-center min-h-screen p-6">
        <div className="max-w-md w-full border-4 border-[#FFFFFF] bg-[#0D0D0D] p-6 shadow-[8px_8px_0px_#2B4EFF]">
          <h2 className="text-xl font-bold uppercase mb-4 text-[#2B4EFF]">
            SYSTEM NOTICE // RECOVERABLE ERROR
          </h2>
